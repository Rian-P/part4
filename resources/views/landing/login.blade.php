        ...
        <section class="mt-0">
            <form class="flex flex-col" method="post" action="{{ route('login.store') }}">
                ...
                <div class="relative inline-block ">
                    ...
                    <div>
                        <input class="rounded-lg border border-gray-300 mb-3 px-2 py-2 w-full" type="email" name="email"
                ...
                <div>
                    <p>
                        <a href="{{route('forget.password.get')}}"
                            class="block text-blue-400 text-sm font-bold mb-1 ml-2 py-2">lupa sandi forgot ? </a>
                    </p>
                </div>
                
                <p class="mt-4 text-center text-gray-500">Already have an account? <a href="/register"
                        class="text-indigo-500 hover:text-indigo-700 font-semibold">Register</a></p>
