        ...
        <div class="flex justify-between items-center mx-auto max-w-screen-xl px-4 md:px-6 py-2.5">
            <div class="flex flex flex-row mt-0 mr-6 space-x-8 text-sm font-medium">
                ...
                <div class="hidden md:flex items-center space-x-1">
                    ...
                    @endif
                    <a href=""
                        class="py-4 px-2 text-gray-500 font-semibold hover:text-green-500 transition duration-300">Tentang
                        Kami</a>
                </div>
            </div>
    ...
    <div class="hidden mobile-menu">
        <ul class="">
            ...
            <li><a href="{{ route('mobil.index') }}"
                    class="block text-sm px-2 py-4 text-black bg-green-500 font-semibold hover:text-green-500  transition duration-300">Layanan Sewa</a></li>
            @if (Auth::check() && Auth::user()->level == 'User')
