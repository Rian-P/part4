                    ...
                    <div class="card-body">
                        ...
                        <form action="/add-pemesanan" class="form-car pt-4" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Jam
                                            Pengembalian</label>
                            ...
                            <div class="row">
                                <div class="col-5">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" type="number" name="total_harga" id="total_harga"
                                            class="form-control" id="exampleFormControlInput1" placeholder="Harga Total"
                                            readonly required>
                                    </div>
                                </div>
                            </div>
